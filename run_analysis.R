...
<html lang="en">
  ...
  <meta name="request-id" content="2A15:1099:FC331B:1BCE345:5C7BD69D" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="2A15:1099:FC331B:1BCE345:5C7BD69D" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="ca6b25aecdace90de67463621cfdc5f2b0d77a6c">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-scope-type="Repository" data-scope-id="32694259" data-scoped-search-url="/bgentry/coursera-getting-and-cleaning-data-project/search" data-unscoped-search-url="/search" action="/bgentry/coursera-getting-and-cleaning-data-project/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=fxJkfoOsTYKRkEUZZATFb8m0gV/M7nWA9TqvIG+xsMpOvc4zKhAxfCPmednhXK7g608C9RoJXeXJt4aXd5nM9g=="
          spellcheck="false"
          autocomplete="off"
          >
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2Fbgentry%2Fcoursera-getting-and-cleaning-data-project%2Fblob%2Fmaster%2Frun_analysis.R" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
  ...
  <li>
    ...
    <a href="/bgentry/coursera-getting-and-cleaning-data-project/network/members" class="social-count"
       aria-label="650 users forked this repository">
      650
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts security people /bgentry/coursera-getting-and-cleaning-data-project/pulse" href="/bgentry/coursera-getting-and-cleaning-data-project/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <!-- blob contrib key: blob_contributors:v21:89c6977114bde0953032eb18e11f241b -->

        <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="25Lmx1nCh32tJ2UTleeZw2Tz1RxCgxVv3SKvMZJ/wi4gQ/SPWybtVHr24THHwlqE9WUFGQYTafjoxFTilPEgvQ==" />
...
<details class="details-reset details-overlay select-menu branch-select-menu float-left">
  ...
  <details-menu class="select-menu-modal position-absolute" style="z-index: 99;" src="/bgentry/coursera-getting-and-cleaning-data-project/ref-list/master/run_analysis.R?source_action=show&amp;source_controller=blob" preload>
    <include-fragment class="select-menu-loading-overlay anim-pulse">
      ...
      <div id="blob-path" class="breadcrumb">
        <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/bgentry/coursera-getting-and-cleaning-data-project"><span>coursera-getting-and-cleaning-data-project</span></a></span></span><span class="separator">/</span><strong class="final-path">run_analysis.R</strong>
      </div>
    </div>
  ...
  <div class="commit-tease d-flex flex-column">
      <div class="d-flex flex-justify-between ">
        <span class="pr-md-4">
          ...
          <a class="user-mention" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=114033" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/bgentry">bgentry</a>
            <a data-pjax="true" title="add course project analysis script" class="message" href="/bgentry/coursera-getting-and-cleaning-data-project/commit/12fc6cf71c9628ab9bcd38f608be6741ea845d3b">add course project analysis script</a>
        </span>
        <span class="d-inline-block flex-shrink-0 v-align-bottom ">
          <a class="commit-tease-sha pr-2" href="/bgentry/coursera-getting-and-cleaning-data-project/commit/12fc6cf71c9628ab9bcd38f608be6741ea845d3b" data-pjax>
            12fc6cf
          </a>
    ...
    <div class="Box-header">
      ...
      <h3 class="Box-title">Users who have contributed to this file</h3>
        ...
        <ul class="list-style-none overflow-auto">
            <li class="Box-row">
              <a class="link-gray-dark no-underline" href="/bgentry">
                <img class="avatar mr-2" alt="" src="https://avatars1.githubusercontent.com/u/114033?s=40&amp;v=4" width="20" height="20" />
                bgentry
</a>            </li>
        </ul>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2019 <span title="0.26741s from unicorn-6f876bc878-d6jr2">GitHub</span>, Inc.</li>
